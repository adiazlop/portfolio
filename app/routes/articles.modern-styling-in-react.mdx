...
abstract: "Every beginner is told the same thing: make a small game. I made a narrative escape room instead."
date: '2026-05-01'
banner: /static/crimson-banner.jpg
featured: true
---

Dracula: Crimson Apostle is my first commercial project — a first-person narrative escape room set in a gothic Dracula universe. Inspired by the escape room games of [MC2 Games](https://store.steampowered.com/developer/mc2escapes), and built on top of a previous academic prototype [One Paradox](https://store.steampowered.com/app/3028130/One_Paradox/), this project has been in development for two years and covers every discipline: design, programming, production, and team leadership.
