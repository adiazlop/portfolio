...
export const Monogram = forwardRef(({ highlight, className, ...props }, ref) => {
  ...
  return (
    <svg
      ...
      // We set the display size to 32x32 for a standard navbar feel
      width="32"
      height="32"
      // CRITICAL: This must match the viewBox of your new SVG (0 0 512 512)
      viewBox="0 0 512 512"
      ref={ref}
      {...props}
    >
      <defs>
        <clipPath id={clipId}>
          {/* Your new game controller path data */}
