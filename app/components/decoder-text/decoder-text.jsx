...
const glyphs = [
  'Blueprints', 'C#', 'C++',
  'Actors', 'Prefabs',
  'Components', 'Shaders', 'Materials',
  'Rigidbodies', 'Solid','Raytracing', 'Plugin','Fab', 'Tick',
  'LateUpdate', 'Niagara', 'Vectors',
  'LevelStreaming', 'Colliders', 'Triggers',
  'Vertex', 'Meshes', 'Widget',
  'BigBoss'
];
