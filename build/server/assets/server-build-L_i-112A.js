...
const sprites = "/assets/icons-CiymuUey.svg";
...
const url$1 = "https://www.32bitsstudio.com";
const github = "adiazlop";
const linkedin = "tdl86";
const twitter$1 = "trentadosbits";
const repo = "https://github.com/adiazlop";
...
const frontmatter$1 = {
  ...
  "abstract": "A madman, planed a release in four months. Overscoping, trial and error and year and a half later than expected, Crimson Apostle was published in Steam. this is what I learned.",
  "date": "2022-05-01",
...
const Footer = ({ className }) => /* @__PURE__ */ jsx("footer", { className: classes(styles$l.footer, className), children: /* @__PURE__ */ jsxs(Text, { size: "s", align: "center", children: [
  ...
  /* @__PURE__ */ jsx(Link, { secondary: true, className: styles$l.link, href: "/humans.txt", target: "_self", children: "Original portfolio template crafted by Hamish Williams" })
] }) });
...
const Carousel = lazy(
  () => import("./index-CwnKV92l.js").then((module) => ({ default: module.Carousel }))
);
const Armor = lazy(() => import("./armor-DQ17ybtP.js").then((module) => ({ default: module.Armor })));
...
const sprTextureLarge = "/assets/spr-lesson-builder-dark-large-CKAN_-ye.jpg";
const sprTexturePlaceholder = "/assets/spr-lesson-builder-dark-placeholder-BYjrS8rr.jpg";
const sprTexture = "/assets/spr-lesson-builder-dark-Bfd2R3oB.jpg";
...
const Earth = lazy(() => import("./earth-DWEry6yR.js").then((module) => ({ default: module.Earth })));
const EarthSection = lazy(
  () => import("./earth-DWEry6yR.js").then((module) => ({ default: module.EarthSection }))
);
...
const frontmatter = {
  "title": "Level Design in Dracula: Crimson Apostle",
  "abstract": "When learning game development, Level Design is not a topic you find a lot of resources of, specially written. Also, many tutorials you encounter online are not so well explained as they should be.",
  "date": "2026-05-15",
...
async function getPosts() {
  ...
  const posts = await Promise.all(
    Object.entries(modules).map(async ([file, post2]) => {
      ...
      const text2 = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../articles.hello-world.mdx": () => import("./articles.hello-world-NShh6Old.js"), "../articles.modern-styling-in-react.mdx": () => import("./articles.modern-styling-in-react-slppCDMq.js") }), `../articles.${slug}.mdx`);
          ...
          Link$1,
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: styles$e.postDetails, children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: styles$e.postFooter, children: [
                /* @__PURE__ */ jsx(Button, { secondary: true, iconHoverShift: true, icon: "chevron-right", as: "div", children: "View project" }),
...
function Articles$1() {
  ...
  const postsHeader = /* @__PURE__ */ jsx("header", { className: styles$e.header, children: /* @__PURE__ */ jsx(Heading, { className: styles$e.heading, level: 5, as: "h1", children: /* @__PURE__ */ jsx(DecoderText, { text: "Portfolio projects" }) }) });
...
function meta$6() {
  return baseMeta({
    title: "Portfolio",
    description: "A collection of portfolio projects with context and explanations."
  });
}
...
const sliceTextureLarge = "/assets/slice-app-large-DiRWIeEX.jpg";
...
const sliceTexture = "/assets/slice-app-62Fksg6R.jpg";
    ...
    /* @__PURE__ */ jsx(Transition, { unmount: true, in: actionData == null ? void 0 : actionData.success, children: ({ status, nodeRef }) => /* @__PURE__ */ jsxs("div", { className: styles$6.complete, "aria-live": "polite", ref: nodeRef, children: [
      ...
      /* @__PURE__ */ jsx(
        Text,
        {
          ...
          children: "I’ll get back to you within a couple days"
        }
      ),
      /* @__PURE__ */ jsx(
        Button,
...
const projectFourTextureLarge = "/assets/projectFourTexture-D6TZ3tPn.png";
const projectFourTexturePlaceholder = "/assets/projectFourTexture-D6TZ3tPn.png";
const projectFourTexture = "/assets/projectFourTexture-D6TZ3tPn.png";
function subscribe() {
  return () => {
  };
}
...
const DisplacementSphere = lazy(
  () => import("./displacement-sphere-1hm0EDKV.js").then((module) => ({ default: module.DisplacementSphere }))
);
...
const profileImgLarge = "/assets/profile-large-xHhM30LY.jpg";
const profileImgPlaceholder = "/assets/profile-placeholder-DOgU6wR2.jpg";
const profileImg = "/assets/profile-CxAuvQ1D.jpg";
const profile = "_profile_sykd3_1";
const content$1 = "_content_sykd3_37";
const column = "_column_sykd3_50";
const title$1 = "_title_sykd3_59";
const description$1 = "_description_sykd3_70";
const tag = "_tag_sykd3_80";
const tagText = "_tagText_sykd3_93";
const image = "_image_sykd3_114";
const svg$1 = "_svg_sykd3_119";
const button$1 = "_button_sykd3_135";
const styles$4 = {
  profile,
  content: content$1,
  column,
...
const ProfileText = ({ visible, titleId }) => /* @__PURE__ */ jsxs(Fragment, { children: [
  ...
  /* @__PURE__ */ jsxs(Text, { className: styles$4.description, "data-visible": visible, size: "l", as: "p", children: [
    "I’m Toni, game developer and founder of ",
    /* @__PURE__ */ jsx(Link, { href: "https://wwww.32bits-studio.coom", children: "32 Bits Studio" }),
    ".",
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx("br", {}),
  ...
  /* @__PURE__ */ jsx(Text, { className: styles$4.description, "data-visible": visible, size: "l", as: "p" })
] });
...
const Model = lazy(
  () => import("./index-KaseYc6F.js").then((module) => ({ default: module.Model }))
);
function ProjectSummary({
  ...
  function renderPreview(visible) {
    return /* @__PURE__ */ jsxs("div", { className: styles$3.preview, children: [
      model2.type === "laptop" && /* @__PURE__ */ jsx(Fragment$1, { children: /* @__PURE__ */ jsxs("div", { className: styles$3.model, "data-device": "laptop", children: [
      ...
      model2.type === "phone" && /* @__PURE__ */ jsx(Fragment$1, { children: /* @__PURE__ */ jsxs("div", { className: styles$3.model, "data-device": "phone", children: [
        !modelLoaded && /* @__PURE__ */ jsx(Loader, { center: true, className: styles$3.loader, "data-visible": visible }),
        isHydrated && visible && /* @__PURE__ */ jsx(Suspense, { children: /* @__PURE__ */ jsx(
          Model,
          {
...
const Home = () => {
  ...
  useEffect(() => {
    const sections = [intro2, projectOne, projectTwo, projectThree, projectFour, aboutMe];
...
const serverManifest = { "entry": { "module": "/assets/entry.client-DTlHR81J.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-DlHaQd3O.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-6nXgnAZT.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-DlHaQd3O.js", "/assets/image-BxD5i0xJ.js", "/assets/error-dFdl7QT7.js", "/assets/visually-hidden-B3vCCyhn.js", "/assets/heading-B3SjN0va.js", "/assets/useScrollToHash-D_ziCmc_.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/config-BPs1knC4.js", "/assets/decoder-text-CiaCsi76.js", "/assets/use-spring-CSvtnvRH.js", "/assets/index-DY7g4Kkp.js"], "css": ["/assets/root-3CgR45Fi.css", "/assets/image-CQFqa4Pm.css", "/assets/heading-DxmoR0-i.css", "/assets/error-CmEnn51Q.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/visually-hidden-DZKbrLgw.css"] }, "routes/articles.modern-styling-in-react": { "id": "routes/articles.modern-styling-in-react", "parentId": "routes/articles", "path": "modern-styling-in-react", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.modern-styling-in-react-DGKst1eD.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/index-L_4ix5aQ.js"], "css": [] }, "routes/projects.volkihar-knight": { "id": "routes/projects.volkihar-knight", "parentId": "root", "path": "projects/volkihar-knight", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CcU6dvBl.js", "imports": ["/assets/components-DlHaQd3O.js", "/assets/jsx-runtime-DexIYAB0.js", "/assets/heading-B3SjN0va.js", "/assets/meta-Cya1HW2n.js", "/assets/image-BxD5i0xJ.js", "/assets/project-Dh72VwMZ.js", "/assets/config-BPs1knC4.js", "/assets/useParallax-CtGDR_RQ.js"], "css": ["/assets/route-BT5UbU5w.css", "/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css"] }, "routes/projects.smart-sparrow": { "id": "routes/projects.smart-sparrow", "parentId": "root", "path": "projects/smart-sparrow", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-qnH4-cNy.js", "imports": ["/assets/components-DlHaQd3O.js", "/assets/jsx-runtime-DexIYAB0.js", "/assets/spr-lesson-builder-dark-B-heb-1l.js", "/assets/meta-Cya1HW2n.js", "/assets/image-BxD5i0xJ.js", "/assets/visually-hidden-B3vCCyhn.js", "/assets/heading-B3SjN0va.js", "/assets/project-Dh72VwMZ.js", "/assets/config-BPs1knC4.js", "/assets/useParallax-CtGDR_RQ.js"], "css": ["/assets/route-PiXNUkZG.css", "/assets/meta-CUrllC_C.css", "/assets/heading-DxmoR0-i.css", "/assets/image-CQFqa4Pm.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/project-D3JpM_tk.css"] }, "routes/articles.hello-world": { "id": "routes/articles.hello-world", "parentId": "routes/articles", "path": "hello-world", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.hello-world-YblCpcvN.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/index-L_4ix5aQ.js"], "css": [] }, "routes/articles_._index": { "id": "routes/articles_._index", "parentId": "root", "path": "articles", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CYR-Fo5S.js", "imports": ["/assets/meta-Cya1HW2n.js", "/assets/jsx-runtime-DexIYAB0.js", "/assets/heading-B3SjN0va.js", "/assets/decoder-text-CiaCsi76.js", "/assets/divider-gvPKybmx.js", "/assets/image-BxD5i0xJ.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/date-DvyCAN0s.js", "/assets/components-DlHaQd3O.js", "/assets/config-BPs1knC4.js", "/assets/visually-hidden-B3vCCyhn.js", "/assets/use-spring-CSvtnvRH.js", "/assets/index-DY7g4Kkp.js"], "css": ["/assets/route-DtSYASGB.css", "/assets/meta-CUrllC_C.css", "/assets/heading-DxmoR0-i.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/divider-CJ0zz9kw.css", "/assets/image-CQFqa4Pm.css"] }, "routes/projects.slice": { "id": "routes/projects.slice", "parentId": "root", "path": "projects/slice", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CssLJZ47.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/slice-app-Dm9B5u9Z.js", "/assets/meta-Cya1HW2n.js", "/assets/image-BxD5i0xJ.js", "/assets/project-Dh72VwMZ.js", "/assets/heading-B3SjN0va.js", "/assets/components-DlHaQd3O.js", "/assets/config-BPs1knC4.js", "/assets/useParallax-CtGDR_RQ.js"], "css": ["/assets/route-BMFIlMHl.css", "/assets/meta-CUrllC_C.css", "/assets/heading-DxmoR0-i.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css"] }, "routes/api.set-theme": { "id": "routes/api.set-theme", "parentId": "root", "path": "api/set-theme", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/api.set-theme-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/articles": { "id": "routes/articles", "parentId": "root", "path": "articles", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BY2YW9ac.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/divider-gvPKybmx.js", "/assets/meta-Cya1HW2n.js", "/assets/heading-B3SjN0va.js", "/assets/image-BxD5i0xJ.js", "/assets/useParallax-CtGDR_RQ.js", "/assets/useScrollToHash-D_ziCmc_.js", "/assets/clamp-e7DugykH.js", "/assets/date-DvyCAN0s.js", "/assets/components-DlHaQd3O.js", "/assets/list-CBYOh5Yg.js", "/assets/index-L_4ix5aQ.js", "/assets/config-BPs1knC4.js"], "css": ["/assets/route-CMd6_K8x.css", "/assets/divider-CJ0zz9kw.css", "/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/list-DkijDrbu.css"] }, "routes/contact": { "id": "routes/contact", "parentId": "root", "path": "contact", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-hgBu7yhn.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/heading-B3SjN0va.js", "/assets/decoder-text-CiaCsi76.js", "/assets/divider-gvPKybmx.js", "/assets/meta-Cya1HW2n.js", "/assets/components-DlHaQd3O.js", "/assets/visually-hidden-B3vCCyhn.js", "/assets/use-spring-CSvtnvRH.js", "/assets/index-DY7g4Kkp.js", "/assets/config-BPs1knC4.js"], "css": ["/assets/route-DZ4V55Yk.css", "/assets/heading-DxmoR0-i.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/divider-CJ0zz9kw.css", "/assets/meta-CUrllC_C.css"] }, "routes/home": { "id": "routes/home", "parentId": "root", "path": "home", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DP-UifDQ.js", "imports": ["/assets/route-DsxyG_7R.js", "/assets/jsx-runtime-DexIYAB0.js", "/assets/slice-app-Dm9B5u9Z.js", "/assets/spr-lesson-builder-dark-B-heb-1l.js", "/assets/meta-Cya1HW2n.js", "/assets/heading-B3SjN0va.js", "/assets/components-DlHaQd3O.js", "/assets/config-BPs1knC4.js", "/assets/decoder-text-CiaCsi76.js", "/assets/visually-hidden-B3vCCyhn.js", "/assets/use-spring-CSvtnvRH.js", "/assets/index-DY7g4Kkp.js", "/assets/image-BxD5i0xJ.js", "/assets/useScrollToHash-D_ziCmc_.js", "/assets/divider-gvPKybmx.js", "/assets/useWindowSize-mzNSXuUf.js"], "css": ["/assets/route-nqBd7E7p.css", "/assets/meta-CUrllC_C.css", "/assets/heading-DxmoR0-i.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/image-CQFqa4Pm.css", "/assets/divider-CJ0zz9kw.css"] }, "routes/uses": { "id": "routes/uses", "parentId": "root", "path": "uses", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DxYotgSI.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/meta-Cya1HW2n.js", "/assets/list-CBYOh5Yg.js", "/assets/project-Dh72VwMZ.js", "/assets/heading-B3SjN0va.js", "/assets/components-DlHaQd3O.js", "/assets/config-BPs1knC4.js", "/assets/image-BxD5i0xJ.js", "/assets/useParallax-CtGDR_RQ.js"], "css": ["/assets/route-CJWqkCSj.css", "/assets/meta-CUrllC_C.css", "/assets/heading-DxmoR0-i.css", "/assets/list-DkijDrbu.css", "/assets/project-D3JpM_tk.css", "/assets/image-CQFqa4Pm.css"] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/_-CUK7lVtr.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/error-dFdl7QT7.js", "/assets/components-DlHaQd3O.js", "/assets/heading-B3SjN0va.js", "/assets/decoder-text-CiaCsi76.js", "/assets/visually-hidden-B3vCCyhn.js", "/assets/use-spring-CSvtnvRH.js", "/assets/index-DY7g4Kkp.js", "/assets/image-BxD5i0xJ.js"], "css": ["/assets/error-CmEnn51Q.css", "/assets/heading-DxmoR0-i.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/image-CQFqa4Pm.css"] }, "routes/home/route": { "id": "routes/home/route", "parentId": "root", "path": "/", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DP-UifDQ.js", "imports": ["/assets/route-DsxyG_7R.js", "/assets/jsx-runtime-DexIYAB0.js", "/assets/slice-app-Dm9B5u9Z.js", "/assets/spr-lesson-builder-dark-B-heb-1l.js", "/assets/meta-Cya1HW2n.js", "/assets/heading-B3SjN0va.js", "/assets/components-DlHaQd3O.js", "/assets/config-BPs1knC4.js", "/assets/decoder-text-CiaCsi76.js", "/assets/visually-hidden-B3vCCyhn.js", "/assets/use-spring-CSvtnvRH.js", "/assets/index-DY7g4Kkp.js", "/assets/image-BxD5i0xJ.js", "/assets/useScrollToHash-D_ziCmc_.js", "/assets/divider-gvPKybmx.js", "/assets/useWindowSize-mzNSXuUf.js"], "css": ["/assets/route-nqBd7E7p.css", "/assets/meta-CUrllC_C.css", "/assets/heading-DxmoR0-i.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/image-CQFqa4Pm.css", "/assets/divider-CJ0zz9kw.css"] } }, "url": "/assets/manifest-407d6d77.js", "version": "407d6d77" };
